...
densenet_232_k48 = nn.Sequential( # Sequential,
	...
	nn.BatchNorm2d(2688),
	nn.ReLU(),
	nn.Conv2d(2688,1344,(1, 1),(1, 1),(0, 0),1,1,bias=False),
	nn.AvgPool2d((2, 2),(2, 2)),
	LambdaReduce(lambda x,y,dim=1: torch.cat((x,y),dim), # Concat,
		Lambda(lambda x: x), # Identity,
		nn.Sequential( # Sequential,
	...
	nn.Sequential(Lambda(lambda x: x.view(1,-1) if 1==len(x.size()) else x ),nn.Linear(3648,1000)), # Linear,
)