...
densenet_cosine_264_k32 = nn.Sequential( # Sequential,
	...
	LambdaReduce(lambda x,y,dim=1: torch.cat((x,y),dim), # Concat,1
	...
	LambdaReduce(lambda x,y,dim=1: torch.cat((x,y),dim), # Concat,2
		Lambda(lambda x: x), # Identity,
		nn.Sequential( # Sequential,
			nn.BatchNorm2d(96),
			nn.ReLU(),
	...
	LambdaReduce(lambda x,y,dim=1: torch.cat((x,y),dim), # Concat,3
		Lambda(lambda x: x), # Identity,
		nn.Sequential( # Sequential,
			nn.BatchNorm2d(128),
			nn.ReLU(),
	...
	LambdaReduce(lambda x,y,dim=1: torch.cat((x,y),dim), # Concat,4
		Lambda(lambda x: x), # Identity,
		nn.Sequential( # Sequential,
			nn.BatchNorm2d(160),
			nn.ReLU(),
	...
	LambdaReduce(lambda x,y,dim=1: torch.cat((x,y),dim), # Concat,5
		Lambda(lambda x: x), # Identity,
		nn.Sequential( # Sequential,
			nn.BatchNorm2d(192),
			nn.ReLU(),
	...
	LambdaReduce(lambda x,y,dim=1: torch.cat((x,y),dim), # Concat,6
		Lambda(lambda x: x), # Identity,
		nn.Sequential( # Sequential,
			nn.BatchNorm2d(224),
			nn.ReLU(),
